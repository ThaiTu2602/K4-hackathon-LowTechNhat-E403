...
- **Evidence:**
  - **Số liệu mining / kết quả khảo sát:** (Dữ liệu giả định dựa trên bối cảnh) Khảo sát 30 học viên, 80% cho biết gặp khó khăn khi tìm kiếm thông tin tiện ích trong tuần đầu; 20/30 post rủ đá bóng trên Discord/Facebook bị trôi và không chốt được lịch.
  - **≥5 quote/ví dụ nguyên văn + nguồn:**
    1. *"Cho mình hỏi căn tin có lò vi sóng không mọi người ơi?"* (Discord - Kênh chung)
    2. *"Chiều nay 5h có ai đá bóng sân nội khu không, thiếu 2 slot!"* (Facebook Group) - *[Kết quả: Không ai comment kịp]*
    3. *"Thẻ từ của mình quẹt không vào được thư viện, phải liên hệ ai vậy?"* (Discord - Kênh hỏi đáp)
    4. *"Có team nào rảnh tối nay đá giao hữu không, gom mãi mới được 4 người."* (Discord - Kênh thể thao)
...
- **Bảng impact ≥3 ứng viên:**
  ...
  |---|---|---|---|---|---|
  | 1. Trợ lý Discord hỏi đáp & gom nhóm | ~50 (toàn bộ hv) | 2-3 lần/tuần | 15-30 phút chờ | Có (Dùng Python + Discord.py) | **Chọn** |
...
## §4. Thiết kế
- **Lát cắt MỘT CÂU:** Khi học viên nhắn câu hỏi hoặc nhu cầu vào Discord, AI sẽ truy xuất tài liệu để trả lời hoặc tự động gọi tool tạo poll gom nhóm thể thao và chốt lịch.
...
- **Automation:** [x] Conditional 
  - Lý do: AI tự làm (Automate) khi sinh câu trả lời dựa trên tài liệu chắc chắn. Chuyển sang hỏi lại người dùng (Conditional) nếu thiếu tham số để lập kèo (ví dụ: "chiều nay đá bóng" -> thiếu giờ và địa điểm). Sai sót trả lời thông tin tiện ích rẻ (user có thể đính chính), nhưng lập kèo sai giờ sẽ gây bực mình.
- **§4b. Nguyên tắc đã áp dụng (≥4 — HAX/PAIR):**
  ...
  | **G8 - Gạt bỏ dễ dàng** | Khi bot tạo lệnh gom nhóm (Poll), người gọi lệnh có nút "Huỷ kèo" nếu AI hiểu sai ý định. |
...
| 7. Bot tạo poll lịch đá bóng sai giờ (15h thay vì 5h chiều) | ④ Đặc thù | Hiển thị nút "Huỷ/Sửa kèo" ngay dưới tin nhắn để user tự đính chính. | G8, G9 |
